            ...
            <div class="row justify-content-center">
                <div class="col-md-4 col-sm-6">
                    <div class="single-feature single-feature-img-top text-center" data-animate="fadeInUp" data-delay=".1">
                        <div class="single-feature-img">
                            <img src="lander-plugins/img/icons/setup.svg" alt="" class="svg">
                        </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single-feature single-feature-img-top text-center" data-animate="fadeInUp" data-delay=".4">
                        <div class="single-feature-img">
                            <img src="lander-plugins/img/icons/download.svg" alt="" class="svg">
                        </div>
                        <div class="single-feature-content">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single-feature single-feature-img-top text-center" data-animate="fadeInUp" data-delay=".7">
                        <div class="single-feature-img">
                            <img src="lander-plugins/img/icons/support.svg" alt="" class="svg">
                        </div>
                        <div class="single-feature-content">
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="single-service single-service-white text-center" data-animate="fadeInUp" data-delay=".1">
                        <img src="lander-plugins/img/icons/earth.svg" alt="" class="svg">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-service single-service-white text-center" data-animate="fadeInUp" data-delay=".4">
                        <img src="lander-plugins/img/icons/phone.svg" alt="" class="svg">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-service single-service-white text-center" data-animate="fadeInUp" data-delay=".7">
                        <img src="lander-plugins/img/icons/tv.svg" alt="" class="svg">
                        <h4>Assured Rates</h4>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-service single-service-white text-center" data-animate="fadeInUp" data-delay="1">
                        <img src="lander-plugins/img/icons/server.svg" alt="" class="svg">
                        <h4>Plan Upgrades</h4>
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6">
                    <div class="single-feature single-feature-img-left text-left" data-animate="fadeInUp" data-delay=".05">
                        <div class="single-feature-img">
                            <img src="lander-plugins/img/icons/ftp.svg" alt="" class="svg">
                        </div>
                        <div class="single-feature-content">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single-feature single-feature-img-left text-left" data-animate="fadeInUp" data-delay=".2">
                        <div class="single-feature-img">
                            <img src="lander-plugins/img/icons/upgrade.svg" alt="" class="svg">
                        </div>
                        <div class="single-feature-content">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single-feature single-feature-img-left text-left" data-animate="fadeInUp" data-delay=".35">
                        <div class="single-feature-img">
                            <img src="lander-plugins/img/icons/data.svg" alt="" class="svg">
                        </div>
                        <div class="single-feature-content">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single-feature single-feature-img-left text-left" data-animate="fadeInUp" data-delay=".5">
                        <div class="single-feature-img">
                            <img src="lander-plugins/img/icons/lock.svg" alt="" class="svg">
                        </div>
                        <div class="single-feature-content">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single-feature single-feature-img-left text-left" data-animate="fadeInUp" data-delay=".65">
                        <div class="single-feature-img">
                            <img src="lander-plugins/img/icons/cloud.svg" alt="" class="svg">
                        </div>
                        <div class="single-feature-content">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single-feature single-feature-img-left text-left" data-animate="fadeInUp" data-delay=".8">
                        <div class="single-feature-img">
                            <img src="lander-plugins/img/icons/access.svg" alt="" class="svg">
                        </div>
                        <div class="single-feature-content">
                ...
                <div class="col">
                    ...
                    <div class="review-slider-wraper position-relative">
                        <div class="swiper-container review-slider">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="review-author d-flex align-items-center">
                                        <div class="review-author-img">
                                            <img src="lander-plugins/img/authors/female.png" alt="">
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="review-author d-flex align-items-center">
                                        <div class="review-author-img">
                                            <img src="lander-plugins/img/authors/male.png" alt="">
                                        </div>
                                        <div class="review-author-info">
                                            <ul class="list-inline">
                                                <li><i class="fa fa-star"></i></li>
                        ...
                        <div class="swiper-button-next next-review">
                            <img src="lander-plugins/img/icons/right-arrow.svg" alt="" class="svg">
                        </div>
                        <div class="swiper-button-prev prev-review">
                            <img src="lander-plugins/img/icons/left-arrow.svg" alt="" class="svg">
                        </div>
                    </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="popup-video mb-50" data-animate="fadeInUp" data-delay=".4">
                        <img src="lander-plugins/img/video-thumb.jpg" data-rjs="2" alt="">
                        ...
                        <div class="swiper-container news-slider">
                            <div class="swiper-wrapper">
                                <div class="single-news swiper-slide">
                                    ...
                                    <img src="lander-plugins/img/posts/post1.jpg" data-rjs="2" alt="">
                                    <ul class="list-unstyled d-flex align-items-center">
                                        <li><img src="lander-plugins/img/authors/author1.jpg" alt=""></li>
                                ...
                                <div class="single-news swiper-slide">
                                    <a class="tip" href="#">News</a>
                                    <img src="lander-plugins/img/posts/post2.jpg" data-rjs="2" alt="">
                                    <ul class="list-unstyled d-flex align-items-center">
                                        <li><img src="lander-plugins/img/authors/male.png" alt=""></li>
                                        <li>by <a href="#">Zane M. Frye</a></li>
                                        <li><a href="#">January 19, 2018</a></li>
                                    </ul>
                                ...
                                <div class="single-news swiper-slide">
                                    <a class="tip" href="#">News</a>
                                    <img src="lander-plugins/img/posts/post3.jpg" data-rjs="2" alt="">
                                    <ul class="list-unstyled d-flex align-items-center">
                                        <li><img src="lander-plugins/img/authors/female.png" alt=""></li>
                                        <li>by <a href="#">Zane M. Frye</a></li>
                                        <li><a href="#">January 19, 2018</a></li>
                                    </ul>
                        ...
                        <div class="swiper-container product-carousel">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide single-product">
                                    ...
                                    <img src="lander-plugins/img/products/product1.jpg" data-rjs="2" alt="">
                                    <ul class="list-inline">
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
                                ...
                                <div class="swiper-slide single-product">
                                    ...
                                    <img src="lander-plugins/img/products/product2.jpg" data-rjs="2" alt="">
                                    <ul class="list-inline">
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
                                ...
                                <div class="swiper-slide single-product">
                                    <span class="tip">New</span>
                                    <img src="lander-plugins/img/products/product3.jpg" data-rjs="2" alt="">
                                    <ul class="list-inline">
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
                                ...
                                <div class="swiper-slide single-product">
                                    <span class="tip">New</span>
                                    <img src="lander-plugins/img/products/product4.jpg" data-rjs="2" alt="">
                                    <ul class="list-inline">
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
                                ...
                                <div class="swiper-slide single-product">
                                    <span class="tip">New</span>
                                    <span class="discount">25% off</span>
                                    <img src="lander-plugins/img/products/product5.jpg" data-rjs="2" alt="">
                                    <ul class="list-inline">
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
                                ...
                                <div class="swiper-slide single-product">
                                    <span class="tip">New</span>
                                    <span class="discount">25% off</span>
                                    <img src="lander-plugins/img/products/product6.jpg" data-rjs="2" alt="">
                                    <ul class="list-inline">
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
            ...
            <div class="row">
                <div class="col">
                    <ul class="brands list-unstyled d-flex flex-wrap align-items-center justify-content-center justify-content-md-between mb-0">
                        <li data-animate="fadeInUp" data-delay=".05"><img src="lander-plugins/img/brands/brand1.png" alt=""></li>
                        <li data-animate="fadeInUp" data-delay=".2"><img src="lander-plugins/img/brands/brand2.png" alt=""></li>
                        <li data-animate="fadeInUp" data-delay=".35"><img src="lander-plugins/img/brands/brand3.png" alt=""></li>
                        <li data-animate="fadeInUp" data-delay=".5"><img src="lander-plugins/img/brands/brand4.png" alt=""></li>
                        <li data-animate="fadeInUp" data-delay=".65"><img src="lander-plugins/img/brands/brand5.png" alt=""></li>
                        <li data-animate="fadeInUp" data-delay=".8"><img src="lander-plugins/img/brands/brand6.png" alt=""></li>
                    </ul>
                </div>
            </div>
        </div>
